...
def test_process_all_files_workdir_none(mock_abspath, mock_exists, mock_dirname, mock_os_access):
    """
    """
    DIRNAME = '/foo/bar'
    ...
    process_all_files()
    mock_dirname.assert_called_with(DIRNAME)

#@pytest.mark.skipif('True', reason="Work in progress")
@patch('jpeg_rename.os.access')
def test_process_all_files_workdir_not_none(mock_os_access):
    """
    """
...
#@pytest.mark.skipif('True', reason="Work in progress")
@patch('jpeg_rename.os.access')
def test_process_all_files_access_true(mock_os_access):
    """
    """
    mock_os_access.return_value = True
    process_all_files('.')
...
#@pytest.mark.skipif('True', reason="Work in progress")
@patch('jpeg_rename.os.path.exists')
def test_process_all_files_exists_true(mock_os_path):
    """
    """
